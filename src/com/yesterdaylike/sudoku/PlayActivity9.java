 ...
 * @author zheng
 */
public class PlayActivity9 extends Activity
implements OnPageChangeListener, OnTouchListener, OnInstantiateItemListener{
	private static final int squareheight = 3;
	private static final int squarewidth = 3;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mSudokus = mDbHelper.querySudoku("90");
		...
		View view1 = layoutInflater.inflate(R.layout.sudoku_item9, null);
		View view2 = layoutInflater.inflate(R.layout.sudoku_item9, null);
		View view3 = layoutInflater.inflate(R.layout.sudoku_item9, null);
		View view4 = layoutInflater.inflate(R.layout.sudoku_item9, null);
		...
		mSquareViewIds[16] = R.id.Button16;
		mSquareViewIds[17] = R.id.Button17;
		mSquareViewIds[18] = R.id.Button18;
		mSquareViewIds[19] = R.id.Button19;
		mSquareViewIds[20] = R.id.Button20;
		mSquareViewIds[21] = R.id.Button21;
		mSquareViewIds[22] = R.id.Button22;
		mSquareViewIds[23] = R.id.Button23;
		mSquareViewIds[24] = R.id.Button24;
		mSquareViewIds[25] = R.id.Button25;
		mSquareViewIds[26] = R.id.Button26;
		mSquareViewIds[27] = R.id.Button27;
		mSquareViewIds[28] = R.id.Button28;
		mSquareViewIds[29] = R.id.Button29;
		mSquareViewIds[30] = R.id.Button30;
		mSquareViewIds[31] = R.id.Button31;
		mSquareViewIds[32] = R.id.Button32;
		mSquareViewIds[33] = R.id.Button33;
		mSquareViewIds[34] = R.id.Button34;
		mSquareViewIds[35] = R.id.Button35;
		mSquareViewIds[36] = R.id.Button36;
		mSquareViewIds[37] = R.id.Button37;
		mSquareViewIds[38] = R.id.Button38;
		mSquareViewIds[39] = R.id.Button39;
		mSquareViewIds[40] = R.id.Button40;
		mSquareViewIds[41] = R.id.Button41;
		mSquareViewIds[42] = R.id.Button42;
		mSquareViewIds[43] = R.id.Button43;
		mSquareViewIds[44] = R.id.Button44;
		mSquareViewIds[45] = R.id.Button45;
		mSquareViewIds[46] = R.id.Button46;
		mSquareViewIds[47] = R.id.Button47;
		mSquareViewIds[48] = R.id.Button48;
		mSquareViewIds[49] = R.id.Button49;
		mSquareViewIds[50] = R.id.Button50;
		mSquareViewIds[51] = R.id.Button51;
		mSquareViewIds[52] = R.id.Button52;
		mSquareViewIds[53] = R.id.Button53;
		mSquareViewIds[54] = R.id.Button54;
		mSquareViewIds[55] = R.id.Button55;
		mSquareViewIds[56] = R.id.Button56;
		mSquareViewIds[57] = R.id.Button57;
		mSquareViewIds[58] = R.id.Button58;
		mSquareViewIds[59] = R.id.Button59;
		mSquareViewIds[60] = R.id.Button60;
		mSquareViewIds[61] = R.id.Button61;
		mSquareViewIds[62] = R.id.Button62;
		mSquareViewIds[63] = R.id.Button63;
		mSquareViewIds[64] = R.id.Button64;
		mSquareViewIds[65] = R.id.Button65;
		mSquareViewIds[66] = R.id.Button66;
		mSquareViewIds[67] = R.id.Button67;
		mSquareViewIds[68] = R.id.Button68;
		mSquareViewIds[69] = R.id.Button69;
		mSquareViewIds[70] = R.id.Button70;
		mSquareViewIds[71] = R.id.Button71;
		mSquareViewIds[72] = R.id.Button72;
		mSquareViewIds[73] = R.id.Button73;
		mSquareViewIds[74] = R.id.Button74;
		mSquareViewIds[75] = R.id.Button75;
		mSquareViewIds[76] = R.id.Button76;
		mSquareViewIds[77] = R.id.Button77;
		mSquareViewIds[78] = R.id.Button78;
		mSquareViewIds[79] = R.id.Button79;
		mSquareViewIds[80] = R.id.Button80;
		...
		View view = getLayoutInflater().inflate(R.layout.dialog9, null);
		...
		mDialogViewIds[4] = R.id.DialogButton4;
		mDialogViewIds[5] = R.id.DialogButton5;
		mDialogViewIds[6] = R.id.DialogButton6;
		mDialogViewIds[7] = R.id.DialogButton7;
		mDialogViewIds[8] = R.id.DialogButton8;
				...
				if(blank){
					...
					for (int i = 0; i < squarelength; i++ ) {
						...
						if(b){
							...
							mDialogViews[i].setTextColor(getResources().getColor(R.color.purple));
						}
					}
	...
	public boolean OnInstantiateItem(int index, int position) {
		...
		for(int i = 0; i < mSquaresViews.length; i++){
			...
			int key = xi + yi * squarewidth;
			
			if( key % 2 == 0 ){
				mSquaresViews[i].setBackgroundResource(R.drawable.purple_light);
			}
			else{
				mSquaresViews[i].setBackgroundResource(R.drawable.purple_dark);
			}

			if( values[i] == 0 ){
				mSquaresViews[i].setTextColor(getResources().getColor(R.color.purple));
