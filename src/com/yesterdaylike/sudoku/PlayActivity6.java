 ...
 * @author zheng
 */
public class PlayActivity6 extends Activity
implements OnPageChangeListener, OnTouchListener, OnInstantiateItemListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mSudokus = mDbHelper.querySudoku("60");
		...
		View view1 = layoutInflater.inflate(R.layout.sudoku_item6, null);
		View view2 = layoutInflater.inflate(R.layout.sudoku_item6, null);
		View view3 = layoutInflater.inflate(R.layout.sudoku_item6, null);
		View view4 = layoutInflater.inflate(R.layout.sudoku_item6, null);
				...
				if(blank){
					...
					for (int i = 0; i < squarelength; i++ ) {
						...
						if(b){
							...
							mDialogViews[i].setTextColor(Color.GREEN);
						}
					}
	...
	public boolean OnInstantiateItem(int index, int position) {
		...
		for(int i = 0; i < mSquaresViews.length; i++){
			...
			if( ( ( x < 3 ) && ( y < 2 || y > 3 ) ) || ( x > 2 && y > 1 && y < 4 ) ){
				mSquaresViews[i].setBackgroundResource(R.drawable.green_light);
			}
			else{
				mSquaresViews[i].setBackgroundResource(R.drawable.green_dark);
			}

			if( values[i] == 0 ){
				mSquaresViews[i].setTextColor(Color.GREEN);
